...
> 💡 This step is now **optional** — the worker automatically fetches the English
> panel from this repository when the KV keys are missing. Installing them into KV
> just removes the external dependency.
